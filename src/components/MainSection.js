...
function MainSection() {
    ...
    const scrollToAbout = () => {
        ...
        const position = aboutElem.getBoundingClientRect().top + window.pageYOffset
        ...
        <>
            <div id="home-section" className="hero-container">
                ...
                <div className="hero-btns">
                    ...
                    <Button className="btns" buttonStyle='btn--primary' buttonSize='btn--large' linkTo="/projects">
                        My Projects
                    </Button>
                </div>
            </div>

            <div id="about-section" className="article">
                <h1>ABOUT ME</h1>
